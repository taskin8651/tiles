<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('website_setup_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/logos*") ? "c-show" : "" }} {{ request()->is("admin/brands*") ? "c-show" : "" }} {{ request()->is("admin/teams*") ? "c-show" : "" }} {{ request()->is("admin/testimonis*") ? "c-show" : "" }} {{ request()->is("admin/enquiries*") ? "c-show" : "" }} {{ request()->is("admin/contact-details*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @endcan
        @can('add_product_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/product-categories*") ? "c-show" : "" }} {{ request()->is("admin/products-tags*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.addProduct.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('products_tag_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.products-tags.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/products-tags") || request()->is("admin/products-tags/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-folder c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.productsTag.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('product_access')
        ...
        @endcan
        @can('gallery_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/add-galleries*") ? "c-show" : "" }} {{ request()->is("admin/gallery-categories*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('add_gallery_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.add-galleries.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/add-galleries") || request()->is("admin/add-galleries/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
