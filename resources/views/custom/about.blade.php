...
<section class="team-one team-one--about section-space-two" id="team">
    <div class="team-one__bg" style="background-image: url('assets/images/backgrounds/team-bg-1-1.png');"></div>
    <div class="container">
...
<p class="team-one__top__text">
    ...
    trusted service, and reliable solutions for homes and commercial spaces.
        ...
        <div class="team-one__carousel floens-owl__carousel owl-carousel owl-theme" data-owl-options='{
            "items": 3,
            "margin": 30,
            "loop": true,
            "smartSpeed": 700,
            ...
            <div class="item">
                <div class="team-card wow fadeInUp" data-wow-duration='1500ms'>
                    <div class="team-card__image">
                        <img src="{{ $team->upload_file ? $team->upload_file->getUrl() : 'assets/images/team/default.jpg' }}" alt="{{ $team->title }}">
                        <div class="team-card__hover">
                            <div class="team-card__social">
                                @if($team->facebook)
                                    <a href="{{ $team->facebook }}"><i class="icon-facebook"></i><span class="sr-only">Facebook</span></a>
                                @endif
                                @if($team->linkedin)
                                    <a href="{{ $team->linkedin }}"><i class="icon-linkedin"></i><span class="sr-only">LinkedIn</span></a>
                                @endif
                                @if($team->instagram)
                                    <a href="{{ $team->instagram }}"><i class="icon-instagram"></i><span class="sr-only">Instagram</span></a>
                                @endif
                            </div>
                            <div class="team-card__identity">
                                <div class="team-card__identity__inner">
                                    <h3 class="team-card__name"><a href="#">{{ $team->title }}</a></h3>
                                    <span class="team-card__designation">{{ $team->degination }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
