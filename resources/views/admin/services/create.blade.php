...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="brochure">{{ trans('cruds.service.fields.brochure') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.brochure_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="image_1">{{ trans('cruds.service.fields.image_1') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.image_1_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($service) && $service->brochure)
      var file = {!! json_encode($service->brochure) !!}
...
<script>
    ...
    init: function () {
@if(isset($service) && $service->image_1)
      var file = {!! json_encode($service->image_1) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
      file.previewElement.classList.add('dz-complete')
