...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="image_2">{{ trans('cruds.blog.fields.image_2') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.blog.fields.image_2_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="image_3">{{ trans('cruds.blog.fields.image_3') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.blog.fields.image_3_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($blog) && $blog->image_2)
      var file = {!! json_encode($blog->image_2) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
      file.previewElement.classList.add('dz-complete')
...
<script>
    ...
    init: function () {
@if(isset($blog) && $blog->image_3)
      var file = {!! json_encode($blog->image_3) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
      file.previewElement.classList.add('dz-complete')
