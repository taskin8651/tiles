...
<div class="card">
    ...
    <span class="help-block">
        {{ trans('cruds.product.fields.size_helper') }}
    </span>
</div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('finish') ? 'is-invalid' : '' }}" name="finish" id="finish">
                    ...
                    @foreach(App\Models\Product::FINISH_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('finish', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thickness') ? 'is-invalid' : '' }}" type="text" name="thickness" id="thickness" value="{{ old('thickness', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('usage_area') ? 'is-invalid' : '' }}" name="usage_area" id="usage_area">
                    ...
                    @foreach(App\Models\Product::USAGE_AREA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('usage_area', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
