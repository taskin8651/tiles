    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teams.update", [$team->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('degination') ? 'is-invalid' : '' }}" type="text" name="degination" id="degination" value="{{ old('degination', $team->degination) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" name="facebook" id="facebook">{{ old('facebook', $team->facebook) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" name="linkedin" id="linkedin">{{ old('linkedin', $team->linkedin) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" name="instagram" id="instagram">{{ old('instagram', $team->instagram) }}</textarea>
